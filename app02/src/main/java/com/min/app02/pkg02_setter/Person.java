...
/*
 * DI 방식 2 - Setter 주입
 * Spring Container 에 있는 bean을 Setter 형식의 메소드의 매개변수에 주입(전달)하는 방식이다.
 * Setter 형식의 메소드에 @Autowired를 한 번만 추가하면 된다. 
 */
@Component // Spring Container에 Person 타입의 person 이름을 가진 bean을 생성합니다.
...
public class Person {
    ...
    /* 실제 setter에 작업 가능하지만 이렇게 할 필요는 없다.
    @Autowired
