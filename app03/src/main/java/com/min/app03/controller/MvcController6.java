...
public class MvcController6 {
  ...
  @RequestMapping(value="/webdir6/req06")
  public void main() {
    
  }
  
  // 요청 URL : /webdir6/123
  @RequestMapping(value="/webdir6/{number}") // 경로에 포함된 변수를 number라고 부름
  public String req1(@PathVariable(value="number") int number) { // 경로 변수 number를 int number로 받음
